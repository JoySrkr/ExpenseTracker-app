...
import com.example.expancetracker.adapters.AccountsAdapter;
import com.example.expancetracker.adapters.CategoryAdapter;
import com.example.expancetracker.databinding.FragmentAddTransactionFragementBinding;
import com.example.expancetracker.databinding.ListDialogBinding;
import com.example.expancetracker.models.Account;
...
public class AddTransactionFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.catagory.setOnClickListener(c->{
            ...
            CategoryAdapter categoryAdapter=new CategoryAdapter(getContext(), Constants.categories, new CategoryAdapter.CategoryClickListener() {
                ...
                public void onCategoryClicked(Category category) {
                    binding.catagory.setText(category.getCategoryName());
        ...
        binding.account.setOnClickListener(c-> {
            ...
            accounts.add(new Account(0,"ATM"));
            accounts.add(new Account(0,"OnlineBanking"));
            ...
            //Cash, Bank, ATM OnlineBanking , Other Er niche Dag ante cahile er tag:  dialogBinding.recyclerView.addItemDecoration(new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL));
